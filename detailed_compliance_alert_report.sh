...
printf '%s\n' "standardName, requirementId, sectionId, account, resourceName, resourceType, url, tagKey, tagValue, policyName, policyDescription" > ./detailed_compliance_alert_report_$REPORT_DATE.csv
